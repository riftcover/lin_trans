from PySide6.QtWidgets import QVBoxLayout, QWidget, QPushButton, QMainWindow

from utils import logger

logger.info("video2srt.py is running")
class Video2SRT(QWidget):
    ...
    def setupUi(self):
        ...
        # 导入文件
        self.btn_get_video = QPushButton("选择音视频文件或拖放至此", self)
        ...
        # self.source_language.addItems(['英文','中文'])
        #
        # self.source_language.setCurrentText("英文")
        #
        ...
        # self.source_model.addItems(['多语言模型', '中文模型', '英语模型'])
        #
        ...
        #
        # self.translate_language_combo.setCurrentText("zh-cn")
        ...
        # self.ai_prompt.addItems(['默认'])
        # self.ai_prompt.setCurrentText("默认")
...
#         file_paths, _ = QFileDialog.getOpenFileNames(self.main, "选择视频",
